...
/*   Updated: 2025/11/11 13:34:06 by Raulsanc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	if (render_sprites_init(&g) != 0)
		return (fail("ERROR: sprites init\n", &g));
	if (render_sprites_draw(&g) != 0)
		return (fail("ERROR: sprites draw\n", &g));
